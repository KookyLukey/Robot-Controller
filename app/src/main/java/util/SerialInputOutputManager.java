...
/**
 * Utility class which services a {@link com.hoho.android.usbserial.driver.UsbSerialPort} in its {@link #run()}
 * method.
 *
...
public class SerialInputOutputManager implements Runnable {
    ...
    public interface Listener {
        ...
        /**
         * Called when {@link util.SerialInputOutputManager#run()} aborts due to an
         * error.
         */
